...
if(isset($_POST['Simpan'])){
  ...
  $kasir        =$_POST['kasir'];
		...
		<script type="text/javascript">
			...
			<?php
				echo "<meta http-equiv='refresh' content='0; url=admin.php?page=transaksi.form&&id=$id'>";
       ...
       // eksekusi transaksi
        if(isset($_POST['Kirim'])){
            ...
            ?>
              ...
              <?php
                echo "<meta http-equiv='refresh' content='0; url=admin.php?page=print.view&&id=$id &&tgl=$tgl_pembayaran&&invoice=$invoice'>";
