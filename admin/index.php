    ...
    <div class="row">
        <div class="well col-md-5 center login-box">
		 <?php 
            ...
            <form class="form-horizontal" action="?page=login" method="POST" onSubmit="return validasi(this)">
                <fieldset>
                    ...
                    <p class="center col-md-5">
                        <button class="btn btn-primary"  type="submit" class="btn btn-danger" value="Login">Login</button>
                    </p>
                </fieldset>
            </form>
        </div>
