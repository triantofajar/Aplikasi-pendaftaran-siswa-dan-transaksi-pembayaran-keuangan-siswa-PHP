            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">Menu Tata Usaha &nbsp; Username : <?php echo $_SESSION['nama']; ?></li>
                        <li><a class="ajax-link"  href="interfaces.php"><i class="glyphicon glyphicon-home"></i><span> Beranda</span></a>
                        </li>

						<li><a href="interfaces.php?page=daftar_form"><i class="glyphicon glyphicon-plus"></i><span> Input Pendaftar</span></a>
                        </li>
						<li><a href="interfaces.php?page=daftar.siswa2"><i class="glyphicon glyphicon-list-alt"></i><span> Data Calon Siswa</span></a>
                        </li>
						...
						<li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
								<li><a  href="interfaces.php?page=kelas.pembagian"><i class="glyphicon glyphicon-remove-sign"></i> Input Kelas Siswa</a></li>
								<li><a  href="interfaces.php?page=daftar.kelas"><i class="glyphicon glyphicon-remove-sign"></i> Kelas Siswa</a></li>
