...
<div class="row">
    ...
    <div class="alert alert-info"><h3><strong><?php echo $myData['nama']; ?></strong></h3>
	<p>Nomor Pendaftaran : <?php echo $myData['id_utama']; ?></p></div>
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
    <thead>
     <center><img src="../photo/<?php echo $query['photo']; ?>" width="150" height="200" style="border:2px solid"/>
