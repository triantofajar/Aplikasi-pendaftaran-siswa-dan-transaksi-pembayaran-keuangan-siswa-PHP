            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">Menu Kasir &nbsp; Username : <?php echo $_SESSION['nama']; ?></li>
                        ...
                        <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a  href="interfaces.php?page=transaksi.form"><i class="glyphicon glyphicon-list-alt"></i> Form Pembayaran</a></li>
