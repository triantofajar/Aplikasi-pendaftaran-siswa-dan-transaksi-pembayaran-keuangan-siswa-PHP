            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">Menu Kepala Paud &nbsp; Username : <?php echo $_SESSION['nama']; ?></li>
						...
						<li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a  href="interfaces.php?page=data.siswa"><i class="glyphicon glyphicon-folder-open"></i> Laporan Data Siswa Paud Rosella</a></li>
                                <li><a  href="interfaces.php?page=laporan.view"><i class="glyphicon glyphicon-folder-open"></i> Laporan Keuangan Paud Rosella</a></li>
                                <li><a  href="interfaces.php?page=report.year"><i class="glyphicon glyphicon-folder-open"></i> Laporan Keuangan Pertahun</a></li>
